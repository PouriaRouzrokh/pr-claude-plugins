...
1. **First**: Use the Context7 MCP tool to query up-to-date documentation
2. **Second**: If Context7 doesn't have the answer, search online
3. **Third**: Ask the user for clarification

### UI/Web Testing
For frontend development and web applications:
- Use the agent-browser skill (`/pr:agent-browser`) to interact with and test the UI
...
1. Add package/tool preferences if the project has specific requirements:
...
|------|----------------|-------|
| Package docs | Context7 MCP | Always try first for library documentation |
| UI testing | agent-browser skill | Use for frontend verification |
| [other project-specific preferences] | [tool] | [notes] |
```

2. Add any project-specific conventions or patterns:
   - Code organization rules
   - Naming conventions
   - Required patterns or anti-patterns

3. **Keep it concise**: If a section would be more than 10 lines, consider whether it belongs in a reference document instead
